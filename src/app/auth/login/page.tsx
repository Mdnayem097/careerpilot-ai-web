    ...
    <div className="max-w-md mx-auto py-12 px-4">
      <div className="p-8 rounded-3xl glass-card border border-border space-y-6 shadow-2xl">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Sign in to access your Agentic AI Career Workspace</p>
        </div>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <span className="bg-card px-3 text-[10px] uppercase tracking-wider font-mono text-slate-500 absolute">or email credentials</span>
        </div>
        ...
        <button
          onClick={handleDemo}
          className="w-full py-2.5 rounded-xl border border-border text-slate-300 font-medium text-xs hover:bg-slate-800 transition-colors flex items-center justify-center space-x-2"
        >
